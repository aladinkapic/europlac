$("document").ready(function(){
    ...
    $("#files").change(function() {
        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                if(data['success']){
                    let elem = $("#all-uploaded-files-at-once").append(
                        '<input type="hidden" name="_uploaded_files[]" class="uploaded_ids" value="'+ data['success'] +'">'
                    );
                }
            }
        });
    ...
    $(".save-button").click(function () {
        ...
        $.ajax({
            url : $(this).attr('url'),
            type : 'POST',
            data : {values : values, model : $(this).attr('model'), id : $(this).attr('id'), goto : $(this).attr('goto')},
