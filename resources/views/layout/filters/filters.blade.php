                ...
                <div class="row">
                    <div class="col-md-8 append-filters">
                        ...
                        <div class="btn-group dropright" style="border: 0px;">
                            ...
                            <div class="dropdown-menu return-none fill-column-names" style="height: 250px; margin-left:-85px; top:34px; overflow-y: scroll;">
                            </div>
                        </div>
...
{{--                        </div>--}}
                        ...
                        @foreach( (Request::has('filter') ? Request::get('filter') : [1 => 1]) as $kljuc => $vrijednost )
                            <div class="filter-row" >
                                <div class="input-group mb-2 mt-2">
                                    ...
                                    <input type="text" required="required" name="filter_values[]" autocomplete="off" placeholder="Unesite .." title="Unesite željeni filter .."
        ...
        <div class="col-md-6 text-right">
            <div class="col-md-12 mb-3">
                ...
                <div class="btn btn-secondary btn-sm arhiviraj-izvjestaje" style="height:26px; padding-top:4px;">{{__('Spremite izvještaj')}}</div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                {{__('Molimo Vas da uneste naziv izvještaja:')}}
                                <input type="text" id="archieve-name" class="form-control mt-4">
                            </div>
                            <!-- dialog buttons -->
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary btn-sm close-archiving">{{__('Odustanite')}}</button>
                                <button type="button" class="btn btn-primary btn-sm save-archiving">{{__('Spremite')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
