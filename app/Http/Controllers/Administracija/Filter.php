...
class Filter extends Controller{
    ...
    public static function show($model, $filters){
        return view('layout.filters.filters', ['var' => $model, 'filteri' => $filters]);
    }

    public static function tableHeader($filters, $style = null){
        return view('layout.filters.filters_header', ['filteri' => $filters, 'style' => $style]);
    }
