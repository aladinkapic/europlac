...
$(document).ready(function () {
  ...
  var searchIt = function searchIt() {
    var url = '/nekretnine';
    var index = 0;
    var name = $("#menu_name_of_estate").val();
  ...
  var array_of_results = result.split('filter');
  var searched_results = Array();
  var odd = null,
      even = null;

  for (var i = 1; i < array_of_results.length; i++) {
    var mySubString = array_of_results[i].substring(array_of_results[i].lastIndexOf("=") + 1, array_of_results[i].lastIndexOf("&"));

    if (i === array_of_results.length - 1) {
      var mySubString = array_of_results[i].substring(array_of_results[i].indexOf("=") + 1, array_of_results[i].indexOf("&"));
    }
  ...
  $(".my-select-wrapper").each(function () {
    for (var j = 0; j < searched_results.length; j++) {
      if ($(this).attr('id') === searched_results[j][0]) {
        $(this).attr('value', searched_results[j][1]); //$("#"+searched_results[j][0]+'-paragraph').text(searched_results[j][1]);
...
var selected_estate_id = 1; // $("body").on('click', '.schedule', function ()  {
//
// });
...
/***/ 0:
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/js/app.js ./resources/js/menu/menu.js ./resources/js/pages/estates/contact-about.js ./resources/js/libraries/notify.js ./resources/sass/style.scss ./resources/sass/administracija/style.scss ***!
  \***********************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
