...
function init() {
  ...
  var lat = $("#map-of-estate").attr('lat');
  var lon = $("#map-of-estate").attr('lon');
  var mapOptions = {
  ...
  var mapElement = document.getElementById('map-of-estate'); // Create the Google Map using our element and options defined above
...
/***/ 2:
/*!**************************************************!*\
  !*** multi ./resources/js/maps/single-estate.js ***!
  \**************************************************/
/*! no static exports found */
